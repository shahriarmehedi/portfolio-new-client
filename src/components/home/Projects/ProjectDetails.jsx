                ...
                <div className="animate-bounceIn animate-animated grid grid-cols-1 lg:grid-cols-2 bg-3 w-11/12 lg:w-full mx-auto rounded-box pt-5 pb-10 lg:py-10 lg:pl-10">
                    <div>
                        ...
                        <div className="pt-10 pb-24 lg:pb-0 flex flex-col lg:flex-row justify-center items-center">
                            <a target="_blank" rel="noreferrer" href={singleProject?.projectLiveSite} className="px-3 mx-2 my-3 text-gray-900 py-2 rounded-full bg-green-400 hover:bg-gray-700 hover:text-white transition duration-300">Live Site</a>
                            <a target="_blank" rel="noreferrer" href={singleProject?.projectClientCode} className="px-3 mx-2 my-3 text-gray-900 py-2 rounded-full bg-green-400 hover:bg-gray-700 hover:text-white transition duration-300">Client side code</a>
                            {
                                singleProject?.projectServerCode && <a target="_blank" rel="noreferrer" href={singleProject?.projectServerCode} className="px-3 mx-2 my-3 text-gray-900 py-2 rounded-full bg-green-400 hover:bg-gray-700 hover:text-white transition duration-300">Server side code</a>
                            }
                        </div>
                    </div>
                    <div>
                        <h2 className=" text-xl mb-2 font-semibold text-white">
                            Project: <span className="text-green-400"> {singleProject?.projectName} </span>
                        </h2>
                        <p className="text-sm mb-4 text-green-400 font-light">{singleProject?.projectType}</p>
                        <h2>
                            Technology Used:
                        </h2>
                        {
